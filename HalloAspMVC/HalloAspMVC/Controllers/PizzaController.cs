...
namespace HalloAspMVC.Controllers
{
    public class PizzaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,KCal")] Pizza pizza)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,KCal")] Pizza pizza)
        {
            if (id != pizza.Id)
            {
                return NotFound();
